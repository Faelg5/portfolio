...
(function () {
  ...
  function makeCard(it) {
    const { title, description, context, role, impact, url } = pickI18n(it);
    ...
    const right = el("div", {}, [
      ...
      // Added Context, Role, Impact
      (context || role || impact) ? el("div", { class: "p-story" }, [
        context ? el("div", { class: "p-story-item" }, [el("strong", { text: (htmlLang === 'fr' ? 'Contexte : ' : (htmlLang === 'de' ? 'Kontext: ' : 'Context: ')) }), context]) : null,
        role ? el("div", { class: "p-story-item" }, [el("strong", { text: (htmlLang === 'fr' ? 'Rôle : ' : (htmlLang === 'de' ? 'Rolle: ' : 'Role: ')) }), role]) : null,
        impact ? el("div", { class: "p-story-item" }, [el("strong", { text: (htmlLang === 'fr' ? 'Impact : ' : (htmlLang === 'de' ? 'Ergebnis: ' : 'Impact: ')) }), impact]) : null
      ]) : null,

      tags.length ? el("div", { class: "pf-tags", style: "margin-top:10px" }, tags.map(t => el("span", { class: "badge", text: t }))) : null,
